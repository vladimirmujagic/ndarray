...
private:
    ...
    T          _binary_operation(const T &a, const T &b, std::string op) const;
    ndarray<T> _element_wise_aligned(const ndarray<T> &a, const ndarray<T> &b, std::string op) const;
    ndarray<T> _element_wise_broadcast(const ndarray<T> &a, const ndarray<T> &b, std::string op) const;
